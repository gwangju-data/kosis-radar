...
const INDICATORS = [
  ...
  { id:2,  cat:"사회·복지",  name:"기초생활수급자", orgId:"117", tblId:"DT_117N_A00301",     prdSe:"M", unit:"명",    threshold:5  },
  { id:3,  cat:"사회·복지",  name:"차상위계층",     orgId:"117", tblId:"DT_117N_A00302",     prdSe:"Y", unit:"명",    threshold:5  },
  { id:4,  cat:"사회·복지",  name:"노인 독거가구",  orgId:"101", tblId:"DT_1IN1503",         prdSe:"Y", unit:"가구",  threshold:5  },
  { id:5,  cat:"사회·복지",  name:"장애인 등록",    orgId:"117", tblId:"DT_117N_A00124",     prdSe:"Y", unit:"명",    threshold:3  },
  { id:6,  cat:"사회·복지",  name:"출생아 수",      orgId:"101", tblId:"DT_1B8000F",         prdSe:"Y", unit:"명",    threshold:5  },
  { id:7,  cat:"사회·복지",  name:"합계출산율",     orgId:"101", tblId:"DT_1B8000G",         prdSe:"Y", unit:"명",    threshold:3  },
  { id:8,  cat:"사회·복지",  name:"사망자 수",      orgId:"101", tblId:"DT_1B8000E",         prdSe:"Y", unit:"명",    threshold:3  },
  { id:9,  cat:"사회·복지",  name:"어린이집 수",    orgId:"117", tblId:"DT_117N_A00208",     prdSe:"Y", unit:"개소",  threshold:5  },
  { id:10, cat:"사회·복지",  name:"노인요양시설",   orgId:"117", tblId:"DT_117N_A00402",     prdSe:"Y", unit:"개소",  threshold:5  },
  { id:11, cat:"사회·복지",  name:"아동학대 신고",  orgId:"117", tblId:"DT_117N_A00503",     prdSe:"Y", unit:"건",    threshold:5  },
  { id:12, cat:"사회·복지",  name:"한부모가족",     orgId:"117", tblId:"DT_117N_A00601",     prdSe:"Y", unit:"가구",  threshold:5  },
  { id:13, cat:"경제·고용",  name:"소비자물가지수", orgId:"101", tblId:"DT_1J20004",         prdSe:"M", unit:"지수",  threshold:2  },
  { id:14, cat:"경제·고용",  name:"고용률",         orgId:"101", tblId:"DT_1DA7107S",        prdSe:"M", unit:"%",     threshold:1  },
  { id:15, cat:"경제·고용",  name:"제조업 취업자",  orgId:"101", tblId:"DT_1DA7002S",        prdSe:"M", unit:"천명",  threshold:3  },
  { id:16, cat:"경제·고용",  name:"소상공인 폐업",  orgId:"118", tblId:"DT_180004_E",        prdSe:"Y", unit:"건",    threshold:5  },
  { id:17, cat:"경제·고용",  name:"평균 임금",      orgId:"118", tblId:"DT_OAA108",          prdSe:"M", unit:"원",    threshold:3  },
  { id:18, cat:"경제·고용",  name:"농가소득",       orgId:"101", tblId:"DT_1EB002",          prdSe:"Y", unit:"만원",  threshold:5  },
  { id:19, cat:"경제·고용",  name:"가계부채",       orgId:"301", tblId:"DT_200Y020",         prdSe:"Q", unit:"억원",  threshold:3  },
  { id:20, cat:"경제·고용",  name:"외국인 근로자",  orgId:"118", tblId:"DT_OAD006",          prdSe:"M", unit:"명",    threshold:5  },
  { id:21, cat:"부동산·인구",name:"아파트 매매가",  orgId:"116", tblId:"DT_MLTM_3034",       prdSe:"M", unit:"지수",  threshold:2  },
  { id:22, cat:"부동산·인구",name:"전세가격지수",   orgId:"116", tblId:"DT_MLTM_3035",       prdSe:"M", unit:"지수",  threshold:2  },
  { id:23, cat:"부동산·인구",name:"인구 이동",      orgId:"101", tblId:"DT_1B26001",         prdSe:"M", unit:"명",    threshold:5  },
  { id:24, cat:"부동산·인구",name:"빈집 수",        orgId:"116", tblId:"DT_MLTM_4131",       prdSe:"Y", unit:"호",    threshold:5  },
  { id:25, cat:"부동산·인구",name:"미분양 주택",    orgId:"116", tblId:"DT_MLTM_2086",       prdSe:"M", unit:"호",    threshold:10 },
  { id:26, cat:"교육·환경",  name:"학생 수",        orgId:"334", tblId:"DT_334005_2010",     prdSe:"Y", unit:"명",    threshold:3  },
  { id:27, cat:"교육·환경",  name:"학교폭력 신고",  orgId:"334", tblId:"DT_334031_A001",     prdSe:"Y", unit:"건",    threshold:5  },
  { id:28, cat:"교육·환경",  name:"PM2.5",          orgId:"106", tblId:"DT_106N_99_3100103", prdSe:"M", unit:"㎍/㎥", threshold:10 },
  { id:29, cat:"교육·환경",  name:"해양쓰레기",     orgId:"126", tblId:"DT_126N_EA007",      prdSe:"Y", unit:"톤",    threshold:5  },
  { id:30, cat:"교육·환경",  name:"교통사고",       orgId:"132", tblId:"DT_13204_111",       prdSe:"Y", unit:"건",    threshold:5  },
];
